...
class Profile extends Component {
    render() { 
        return (  
            <React.Fragment>
                <div class='container-fluid container-profile p-0'>
                    <div className='row w-100 h-100 m-0'>
                        <div className='col background'>
                            <div className='row w-100 h-100 justify-content-center text-center no-gutters'>
                                ...
                                <div className='my-auto align-self-start col-7 col-sm-5 col-md-4 col-lg-3 order-1 order-sm-1 order-md-2 order-lg-2'>
